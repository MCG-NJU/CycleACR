...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None,
    ...
    for name, param in model.named_parameters():
        ...
        if (len(param.shape) == 1 or name.endswith(".bias") or name in skip_list) and (name.startswith('encoder.') or name.startswith('blocks.') or name.startswith('norm.')):
            ...
            this_weight_decay = 0.
            scale = lr_scale
        elif name.startswith('encoder.') or name.startswith('blocks.') or name.startswith('norm.'):

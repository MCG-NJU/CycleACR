...
def get_args():
    ...
    # memory
    parser.add_argument('--mem_active', action='store_true')
    parser.set_defaults(mem_active=True)
...
def main(args, ds_init):
    ...
    if args.enable_deepspeed:
        ...
        optimizer = create_optimizer(
            ...
            get_layer_scale=assigner.get_scale if assigner is not None else None, lr_scale=args.lr_scale)
    ...
    mem_active = args.mem_active
    person_pool = utils.auto_load_model(
        ...
        if args.output_dir and args.save_ckpt:
            if (epoch + 1) % args.save_ckpt_freq == 0 or epoch + 1 == args.epochs:
                utils.save_model(
                    ...
                    loss_scaler=loss_scaler, epoch=epoch, model_ema=model_ema, person_pool=person_pool)

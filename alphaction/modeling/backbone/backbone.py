...
from . import slowfast, i3d, swin_transformer
...
@registry.BACKBONES.register("Swin-Tiny")
@registry.BACKBONES.register("Swin-Base")
def build_swin_transformer_backbone(cfg):
    model = swin_transformer.SwinTransformer3D(cfg)
    return model

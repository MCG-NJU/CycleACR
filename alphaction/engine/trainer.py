...
def do_train(
    ...
    for iteration, (slow_video, fast_video, boxes, extras, _) in enumerate(data_loader, start_iter):
        ...
        if iteration % checkpoint_period == 0:
            checkpointer.save("model_{:07d}.pth".format(iteration), **arguments)
...
def val_in_train(
    ...
    output_folders = [None] * num_val_dataset
    if output_dir:
        for idx, dataset_name in enumerate(dataset_names_val):

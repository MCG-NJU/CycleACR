...
_C.MODEL.BACKBONE.SWIN.PATCH_SIZE = (4, 4, 4)
_C.MODEL.BACKBONE.SWIN.IN_CHANS = 3
_C.MODEL.BACKBONE.SWIN.EMBED_SIZE = 96
_C.MODEL.BACKBONE.SWIN.DEPTHS = [2, 2, 6, 2]
_C.MODEL.BACKBONE.SWIN.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.BACKBONE.SWIN.WINDOW_SIZE = (8, 7, 7)
_C.MODEL.BACKBONE.SWIN.MLP_RATIO = 4.
_C.MODEL.BACKBONE.SWIN.QKV_BIAS = True
_C.MODEL.BACKBONE.SWIN.QK_SCALE = None
_C.MODEL.BACKBONE.SWIN.DROP_RATE = 0.
_C.MODEL.BACKBONE.SWIN.ATTN_DROP_RATE = 0.
_C.MODEL.BACKBONE.SWIN.DROP_PATH_RATE = 0.2
_C.MODEL.BACKBONE.SWIN.PATCH_NORM = True
_C.MODEL.BACKBONE.SWIN.USE_CHECKPOINT = False

# ---------------------------------------------------------------------------- #
# CycleACR options
# ---------------------------------------------------------------------------- #
_C.MODEL.CYCLE_ACR = CN()
_C.MODEL.CYCLE_ACR.ACTIVE = False
_C.MODEL.CYCLE_ACR.DEPTH = 2
_C.MODEL.CYCLE_ACR.INSTANCE_DEPTH = 2
_C.MODEL.CYCLE_ACR.LOCAL_FEATURE_LEN = 50
_C.MODEL.CYCLE_ACR.TEMP_FEATURE_LEN = 32
_C.MODEL.CYCLE_ACR.MEM_ACTIVE = False
_C.MODEL.CYCLE_ACR.MAX_PER_SEC = 5
_C.MODEL.CYCLE_ACR.MAX_PERSON = 25
_C.MODEL.CYCLE_ACR.DIM_IN = 2304
_C.MODEL.CYCLE_ACR.DIM_INNER = 1024
_C.MODEL.CYCLE_ACR.DIM_OUT = 2304
_C.MODEL.CYCLE_ACR.PENALTY = True
_C.MODEL.CYCLE_ACR.LENGTH = (30, 30)
_C.MODEL.CYCLE_ACR.MEMORY_RATE = 1
_C.MODEL.CYCLE_ACR.FUSION = "add"
_C.MODEL.CYCLE_ACR.CONV_INIT_STD = 0.01
_C.MODEL.CYCLE_ACR.DROPOUT = 0.
_C.MODEL.CYCLE_ACR.NO_BIAS = False
_C.MODEL.CYCLE_ACR.LAYER_NORM = True
_C.MODEL.CYCLE_ACR.TEMPORAL_POSITION = True
_C.MODEL.CYCLE_ACR.USE_ZERO_INIT_CONV = True
